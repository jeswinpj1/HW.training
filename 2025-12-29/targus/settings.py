...
FILE_NAME = f"targus_{iteration}"

# ----------------------------
# MONGO DB & COLLECTIONS
# ----------------------------
MONGO_DB = f"targus_{iteration}"
...
MONGO_DB_DEDUP = "targus_clean"
MONGO_COLLECTION_DEDUP = "products_unique"
