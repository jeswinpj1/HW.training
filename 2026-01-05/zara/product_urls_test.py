...
# url = "https://www.zara.com/in/en/woman-outerwear-padded-l1195.html?v1=2419045&regionGroupId=232"
# cookies = {
...
# print(sel)
# prurl = sel.xpath('//a[contains(@class, "product-link _item product-grid-product-info__name link")]/@href')
# print(prurl)
...
# File paths
input_file = "/home/user/HW.training/zara_category_urls.txt"
output_file = "/home/user/HW.training/zara_product_urls.json"
...
# XPath for product links
PRODUCT_XPATH = '//a[contains(@class, "product-link _item product-grid-product-info__name link")]/@href'

# Read category URLs from txt
with open(input_file, "r") as f:
    category_urls = [line.strip() for line in f if line.strip()]

all_product_urls = set()  # using set to remove duplicates automatically
...
with open(output_file, "w") as f:
    json.dump(list(all_product_urls), f, indent=2)

print(f"Collected {len(all_product_urls)} unique product URLs. Saved to {output_file}")
